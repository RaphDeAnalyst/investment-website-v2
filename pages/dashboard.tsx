    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-xl p-8 text-center max-w-lg shadow-lg">
          <h2 className="text-red-600 mb-4 text-2xl font-bold">Dashboard Error</h2>
          <p className="text-gray-500 mb-6 leading-6">{error}</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/homepage">
              <button className="bg-green-600 text-white px-6 py-3 rounded-lg border-0 cursor-pointer font-medium hover:bg-green-700 transition-colors">
                Go Back Home
              </button>
            </Link>
          </div>
